  ...
  useEffect(() => {
    const getScores = async () => {
      try {
        ...
        const scores = await fetchScores('athletics-men-200');
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <div className="flex items-center bg-[#07534c] px-6 py-3 rounded-full shadow-md">
            ...
            <h1 className="text-2xl font-black text-[#e7fefe]">Athletics Men's 200m Standings</h1>
          </div>
        </motion.header>
...
export default AthleticsScoreMen200;