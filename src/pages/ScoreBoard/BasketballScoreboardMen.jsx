  ...
  useEffect(() => {
    const getMatches = async () => {
      try {
        ...
        const scores = await fetchScores('basketball-men');
        ...
        const formattedMatches = scores.map(score => ({
          ...
          matchType: score.matchType || 'Basketball Men',
      ...
      <div className="container mx-auto">
        ...
        >
          <div className="flex items-center bg-[#07534c] px-6 py-3 rounded-full shadow-md">
            ...
            <h1 className="text-2xl font-black text-[#e7fefe]">Basketball Men</h1>
          </div>
        </motion.header>
...
export default BasketballScoreboardMen;